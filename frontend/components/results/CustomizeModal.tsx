        ...
        >
            ...
            >
                ...
                <div className="mt-6 space-y-5">
                    <Field label="Panel">
                        <select
                            ...
                            onChange={(e) =>
                                setDraft((d) => ({
                                    ...d,
                                    panelPresetId: e.target
                                        .value as PanelPresetId,
                                }))
                            }
                        ...
                        <p className="mt-1.5 text-xs text-[var(--subtle)]">
                            {preset.efficiency * 100}% efficient ·{" "}
                            {preset.area_sqm} m² · $
                            {preset.cost_per_w_cad.toFixed(2)}/W installed
                        </p>
                    </Field>

                    <Field label={`Panels — ${draft.panelCount}`}>
                        <input
                            type="range"
                            min={PANEL_COUNT_MIN}
                            max={maxPanels}
                    ...
                    <Field label={`Roof tilt — ${draft.tiltDeg}°`}>
                        <input
                            type="range"
                            min={TILT_MIN}
                            max={TILT_MAX}
                ...
                <div className="mt-6 rounded-2xl border border-[var(--border)] bg-[var(--background)] px-4 py-3">
                    ...
                    <p className="mt-1 text-xs text-[var(--muted)]">
                        Actual price is set by the installer
                    </p>
                </div>
